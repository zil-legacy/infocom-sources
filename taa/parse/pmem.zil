...
<ENTRY PMEM PMEM-ALLOC PMEM-TYPE? PMEM-RESET PM-TYPE
       PARSERDEFS-INTERNAL-OBLIST>

<INCLUDE "PARSER-BITDEFS" "BASEDEFS">
...
<DEFINE-GLOBALS PMEM-GLOBALS
	(PMEM-STORE-LENGTH:FIX 500)
	(PMEM-STORE:TABLE <ITABLE 500>)
	(PMEM-STORE-POINTER:<OR TABLE FALSE> <>)
	(PMEM-STORE-WORDS:FIX 500)>
...
<DEFINE PMEM-RESET ("OPT" (FULL?:<OR ATOM FALSE> T))
  <DEBUG-CHECK <AND <GASSIGNED? DEBUG-PARSER>
		    ,DEBUG-PARSER>
	       <PRINT-MANY ,OUTCHAN PRINC
			   PRMANY-CRLF
			   <COND (.FULL? "Full reset")
				 (T "Reset")>
			   "of PMEM; "
			   ,PMEM-WORDS-USED
			   " words used.">>
  <DEBUG20 <SETG PMEM-WORDS-USED 0>>
  <PMEM-STORE-WORDS <PMEM-STORE-LENGTH>>
  <PMEM-STORE-POINTER <PMEM-STORE>>
  T>
...
<DEFINE DO-PMEM-ALLOC PA (TYPE:FIX LENGTH:FIX
  ...
  <DEBUG-CHECK <G? .LENGTH .LEFT>
	       <COND (<ERROR OUT-OF-MEMORY!-ERRORS
			     ...
			     PMEM-ALLOC>
		      <PMEM-STORE-WORDS 500>
		      <SET LEFT 500>
		      <PMEM-STORE-LENGTH <+ <PMEM-STORE-LENGTH> 500>>
		      <PMEM-STORE <SET STOR <ITABLE <PMEM-STORE-LENGTH> 0>>>)
		     (T
		      <RETURN <> .PA>)>>
  <DEBUG20 <SETG PMEM-WORDS-USED <+ ,PMEM-WORDS-USED .LENGTH>>>
  <PMEM-STORE-WORDS <- .LEFT .LENGTH>>
  <PMEM-STORE-POINTER <ZREST .STOR <* .LENGTH 2>>>
