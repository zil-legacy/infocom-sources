...
<COMMAND BACK-TO-CAVE>

<COMMAND RETURN-ALONE>
...
<ROOM UL-2
      (TRAVEL-COMMANDS BACK-TO-CAVE-COMMAND WIDE-PATH-COMMAND NARROW-PATH-COMMAND
                       NUL-COMMAND)
...
"'s side. Thankfully, he was now conscious, though confused.">
			...
			<COND (<IN? ,NYMPH-STONE ,INVENTORY>
			       <TRAVEL-COMMANDS ,UL-2 ,BACK-TO-CAVE-COMMAND>)>
			<UL-MOVE ,UL-2>)>)
	 ...
	 <ACOND ("AUX" RM)
		(BACK
		 ...
		 <COND (<UL-MOVE-CHECK .RM>
			<COND (<IN? ,NYMPH-STONE ,INVENTORY>
			       <TRAVEL-COMMANDS .RM ,BACK-TO-CAVE-COMMAND>
			       <TELL
