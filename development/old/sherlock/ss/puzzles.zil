		...
		(<EQUAL? <LOC .GEM> ,CH-PLAYER>
			<COND
				...
				(<AND	<MC-VERB? LOOK-THRU>
					...
					>
					<COND
						(<IN? ,TH-MAGNIFYING-GLASS ,GL-WINNER>
							<TELL "You see \"">
							<COND
								(<EQUAL? .GEM ,TH-SAPPHIRE>
									<TELL "2:00 a.m.">
								)
							...
							<COND
								(<MC-F? <BAND <GETP ,CH-HOLMES ,P?AUX1> ,K-HOLMES-GEM?>>
...
<ROUTINE RT-EXAMINE-SCRATCH (GEM)
	<COND
		(<EQUAL? <LOC .GEM> ,CH-PLAYER>
			<COND
				(<MC-VERB? EXAMINE>
...
Whittington is shooting " AO " going to help Mr. 'Olmes?\"" CR
		...
		(T
			<TELL
"That would be a waste of bullets." CR
			>
		)
	>
>
...
<ROUTINE RT-WAKE-UP-HOLMES ()
	...
	<TELL	CR "Holmes ">
   <COND
      (<EQUAL? ,TH-NEWSPAPER ,GL-PRSO ,GL-PRSI>
         <TELL
...
<ROUTINE RT-I-HUDSON ("AUX" NUM)
	...
	<SET NUM <GETP ,RM-HOLMES-STUDY ,P?AUX1>>
	<COND
		(<EQUAL? .NUM 0>
			<COND
...
CR "You see Mrs. Hudson come down the stairway." CR
	...
	>
	<COND
		(<OR	<MC-HERE? ,RM-HOLMES-STUDY>
				<EQUAL? <GETP ,RM-HOLMES-STUDY ,P?AUX1> 3>
			>
...
and gives it to Holmes, who glances at it and passes it on to you." CR
		...
		(T
			<RT-ALARM-SET-REL ,RT-I-HUDSON <RT-PARM-SET 0 1 0>>
			<PUTP ,RM-HOLMES-STUDY ,P?AUX1 <+ .NUM 1>>
			<COND
				(<EQUAL? .NUM 0>
					<TELL
...
CR "Holmes and his visitor are talking quietly. After a moment Holmes
looks up and says, \"Ah, here you are Watson.\"" CR CR
			>
		)
		(T
			<TELL
CR "Holmes takes you by the arm and ushers you back to his room. \"Come
with me, Watson. You really should hear this.\"" CR CR
			>
			<RT-GOTO ,RM-HOLMES-STUDY>
		)
	>
	<TELL 
"\"The Crown Jewels have been stolen, Watson.\"
He gives you a piece of paper. \"Here. What do you make of this?\"" CR
	>
	<RTRUE>
>
...
<ROUTINE RT-I-PM-LEAVE ()
	...
	<COND
		(<EQUAL? <LOC ,CH-PLAYER> ,RM-HOLMES-STUDY>
			<TELL
...
out. He slowly walks away into the fog."
			>
		)
...
hope.\" He opens " THE ,LG-BAKER-ST-DOOR " and disappears into the fog."
			>
		)
	>
	<TELL
...
<ROUTINE RT-GET-PIGEON ("AUX" OBJ WHO)
	<COND
		(<BAND <GETP ,CH-TRAINED-PIGEON ,P?AUX1> ,K-PIGEON-TIRED>
			<TELL
"\"He's too young to fly too often."
			>
			<SET OBJ <GETP ,CH-TRAINED-PIGEON ,P?AUX3>>
			<COND
				(<IN? .OBJ ,CH-SHERMAN>
					<TELL
...
<ROUTINE RT-PIGEON-INTEREST (ATT-BIT)
	<COND
		(<AND <EQUAL? .ATT-BIT ,K-PIGEON-GET-RUBY>
				<NOT <BAND <GETP ,CH-TRAINED-PIGEON ,P?AUX1> ,K-PIGEON-SHOWN-RUBY>>
			>
			<TELL
...
referring." CR
	...
	>
	<PUTP ,CH-TRAINED-PIGEON ,P?AUX1 <BOR <GETP ,CH-TRAINED-PIGEON ,P?AUX1> .ATT-BIT>>
	...
	<COND
		(<AND	<BAND <GETP ,CH-TRAINED-PIGEON ,P?AUX1> ,K-PIGEON-SHOWN-RUBY>
			...
			>
			<COND
				(<RT-ALARM-SET? ,RT-I-PIGEON-IMPATIENT>
...
<ROUTINE RT-KILL-PIGEON ()
	...
	<PUTP ,CH-TRAINED-PIGEON ,P?AUX2 0>
...
"With a strength you didn't know he posessed, Sherman wrestles you into
...
you hear about the jewels?\" he asks. \"I'm looking in to it personally and
I don't mind telling you I've a few theories of my own. By the
...
<ROUTINE RT-I-PIGEON-LOSE-INTEREST ()
	...
	<COND
		(<RT-VISIBLE? ,CH-TRAINED-PIGEON>
			<TELL CTHE ,CH-TRAINED-PIGEON " seems to lose interest." CR>
		)
	>
>

;-----------------------------------------------------------------------------
; "RT-I-PIGEON-IMPATIENT"
;-----------------------------------------------------------------------------
...
<ROUTINE RT-I-PIGEON-CIRCLE ("AUX" CIRCLE L)
	<SET CIRCLE <GETP ,CH-TRAINED-PIGEON ,P?AUX2>>
	...
	<COND
		(<OR	<AND
			...
			<PUTP ,CH-TRAINED-PIGEON ,P?AUX1 ,K-PIGEON-TIRED>
			<PUTP ,CH-TRAINED-PIGEON ,P?AUX2 0>
			<MOVE <GETP ,CH-TRAINED-PIGEON ,P?AUX3> ,CH-SHERMAN>
			<COND
				(<AND <EQUAL? .L ,GL-PLACE-CUR>
						<OR
							<NOT <EQUAL? ,GL-WINNER ,CH-PLAYER>>
							<NOT <MC-VERB? WALK>>
						>
					>
					<TELL CR CTHE ,CH-TRAINED-PIGEON " circles above you for the last
time, and flies out of sight." CR>
				)
			>
		)
		(<EQUAL? .CIRCLE 1 2>
			<RT-ALARM-SET-REL ,RT-I-PIGEON-CIRCLE <RT-PARM-SET 0 1 0>>
			<PUTP ,CH-TRAINED-PIGEON ,P?AUX2 <+ .CIRCLE 1>>
			<COND
				(<EQUAL? .L ,GL-PLACE-CUR>
...
<ROUTINE RT-I-BIGBEN ("AUX" HRS MIN SEC YRS MON DAY (RET <>))
	<COND
		(<MC-IS? ,CH-PLAYER ,FL-ASLEEP>
			<RFALSE>
		)
	>

	<COND
		(<AND <MC-T? ,GL-WAIT-BELL>
		...
		(<AND <MC-VERB? WAIT-FOR WAIT>
			...
			<COND
				(<EQUAL?
				 		<RT-CLOCK-CMP
				 			<GET ,GL-TEMP-TIME ,K-HRS>
				 			<GET ,GL-TEMP-TIME ,K-MIN>
				 			<GET ,GL-TEMP-TIME ,K-SEC>
				 			<GET ,GL-TEMP-TIME ,K-YRS>
				 			<GET ,GL-TEMP-TIME ,K-MON>
				 			<GET ,GL-TEMP-TIME ,K-DAY>
				 		>
				 		1
				 	>
					<COND
						(<MC-F? ,GL-WAIT-BELL>
							<TELL
CR "While you wait, you hear, Big Ben strike each hour." CR
							>
						)
					>
					<SET RET T>
	...
	<COND
		(<NOT <EQUAL? ,GL-PLACE-CUR ,RM-CLOCK-TOWER>>
			<TELL CR "In the distance, you hear Big Ben strike the hour." CR>
		)
		(T
			<COND
				(<G? .HRS 12>
					<PUTP ,TH-BELL ,P?AUX1 <- .HRS 12>>
				)
				(T
					<PUTP ,TH-BELL ,P?AUX1 .HRS>
				)
			>
			<RT-I-SWING-BELL>
		)
...
<ROUTINE RT-I-SWING-BELL ("AUX" OBJ NUM POS WHO)
	<SET NUM <GETP ,TH-BELL ,P?AUX1>>
	<SET POS <GETP ,TH-BELL ,P?AUX2>>
	<COND
		(<NOT <EQUAL? ,GL-PLACE-CUR ,RM-CLOCK-TOWER>>
			<RT-RELIEF>
			<PUTP ,TH-BELL ,P?AUX1 0>
			<PUTP ,TH-BELL ,P?AUX2 ,K-BELL-AWAY>
			<RT-ZERO-SECONDS>
			<RFALSE>
		)
	>
	...
	<COND
		(<EQUAL? .POS ,K-BELL-AWAY>
			<PUTP ,TH-BELL ,P?AUX2 ,K-BELL-TOWARDS>
			<TELL "towards you, ">
			<COND
				(<EQUAL? <LOC ,TH-COTTON-BALLS> ,TH-EARS>
					<TELL "ringing loudly, but the cotton protects your ears. The
clapper swings up within reach." CR>
				)
				(T
					...
					<COND
						(<MC-ISNOT? ,TH-HANDS ,FL-LOCKED>
							...
							>
							<TELL
"slap your hands to your ears in an attempt to protect them, dropping
...
<ROUTINE RT-I-INHALE ()
	<COND
		(<MC-IS? ,TH-BREATH ,FL-LOCKED>
			<TELL
CR "Your lungs scream for air. You take a deep breath." CR>
...
;<ROUTINE RT-I-ATTACK-WATSON ()
	<COND
		(<MC-ISNOT? ,CH-MORIARTY ,FL-ASLEEP>
			<TELL
CR "Moriarty says to Akbar, \"Your instructions were to search him. Take that
thing away from him!\"" CR CR

"Akbar walks menacingly towards you." CR
			>
...
"You awake sometime later to find yourself bound hand and foot. Moriarty
is standing over you with a newspaper in his hand." CR CR
...
<ROUTINE RT-I-OUT-OF-TIME ()
	...
	>
	<TELL
" the paper boy run through the streets shouting out,
\"Crown Jewels stolen... the end is near.\"" CR CR
	>
	<COND
		(<EQUAL? ,GL-PLACE-CUR ,RM-LAIR>
			<TELL D ,CH-MORIARTY>
			<COND
...
;<ROUTINE RT-KNOCK-OUT ()
	<COND
		(<MC-ISNOT? ,TH-BREATH ,FL-LOCKED>
			<MC-MAKE ,CH-PLAYER ,FL-ASLEEP>
			<COND
				(<MC-HERE? ,RM-LAIR>
					<TELL "The etherium knocks you out." CR CR>
					<RT-DOES-MORIARTY-WIN>
				)
				(T
					<TELL
"Suddenly, everything starts to spin. You pass out and fall to the
ground. Sometime later you awaken and stumble back to your feet." CR CR
					>
					<RT-CLOCK-JMP 6 0 0>
				)
			>
		...
		(T
			...
			<TELL
"You see everyone in the room pass out."
			>
		)
	>
>
...
;<ROUTINE RT-LIST-PEOPLE (TBL "OPTIONAL" (PTR 0) (OBJ <>))
	<COND
		(<MC-F? .OBJ>
			<SET OBJ ,GL-PLACE-CUR>
		)
	...
	<REPEAT ()
		...
		<COND
			(<FIRST? .OBJ>
				<SET PTR <RT-LIST-PEOPLE .TBL .PTR <FIRST? .OBJ>>>
			)
		>
		<SET OBJ <NEXT? .OBJ>>
	>
...
<ROUTINE RT-SMELL-ETHERIUM? ()
	<COND
		(<AND <MC-HERE? <LOC ,TH-ETHERIUM-GAS>>
				<MC-ISNOT? ,TH-BREATH ,FL-LOCKED>
			>
			...
			<COND
				...
				(<RT-ALARM-SET? ,RT-I-WAKE-UP>
					<RT-CLOCK-SET
						<GET ,GL-TIME-PARM ,K-HRS>
						<GET ,GL-TIME-PARM ,K-MIN>
						<GET ,GL-TIME-PARM ,K-SEC>
						<GET ,GL-TIME-PARM ,K-YRS>
						<GET ,GL-TIME-PARM ,K-MON>
						<GET ,GL-TIME-PARM ,K-DAY>
						<GET ,GL-TIME-PARM ,K-DOW>
					>
					<RT-ALARM-CHK <>>
...
<ROUTINE RT-DOES-MORIARTY-WIN ()
	<COND
		(<AND <MC-IS? ,CH-MORIARTY ,FL-LOCKED>
				<MC-IS? ,CH-AKBAR ,FL-LOCKED>
			>
			<RT-CLOCK-SET 8 30 0 1887 6 20 1>
...
<ROUTINE RT-PROCESS-PASSWORD ()
	<COND
		(<AND <MC-HERE? ,RM-BAR-OF-GOLD>
				<IN? ,TH-CARNATION ,TH-LAPEL>
				<MC-ISNOT? ,CH-AKBAR ,FL-SEEN>
				<EQUAL? <RT-CLOCK-CMP 2 0 0 1887 6 20> -1 0>
			>
			<MC-MAKE ,CH-AKBAR ,FL-SEEN>
			<MOVE ,CH-AKBAR ,RM-BAR-OF-GOLD>
			<TELL
CTHE ,CH-DENKEEPER " disappears into a back room and reappears moments later,
accompanied by a tall, silent man who has dark skin and wears a white
turban." CR CR

"The Indian glances at your "
			>
			<COND
				(<MC-ISNOT? ,TH-WATSONS-HAT ,FL-WORN>
					<TELL "uncovered ">
				)
			>
...
<ROUTINE RT-INSCRIPTION-APPEARS-MSG ()
 	<TELL
"After a few moments, the tomb's inscription comes through onto the piece
of paper." CR
	>
>
...
"Rubbing the paper with the crayon would probably yield better results." CR
		...
		(<MC-VERB? OPEN>
			<TELL
"Getting just a little bit morbid, aren't we?" CR
			>
		)
		(<MC-VERB? TOUCH>
			<COND
				(<EQUAL? .TOMB-NUMBER 1 2 3>
					<TELL
"It feels a little sticky." CR
					>
				)
				(T
					<RT-CYOU-MSG "do" "does">
...
<ROUTINE RT-READ-INSCRIPTION (NUM)
	<COND
		(<EQUAL? 2 .NUM>
			<TELL "The inscription reads, \"ISAACVS NEWTON  Eques Auratus.\"" CR>
			<RTRUE>
		)
		(<EQUAL? 1 .NUM>
			<TELL
"The inscription reads, \"REGNO CONSORTES & VRNA HIC OBDOR
MIMVS ELIZABETHA ET MARIA SORORES IN SPE RESVRRECTIONIS.\"" CR
			>
			<RTRUE>
		)
		(<EQUAL? 7 .NUM>
			<TELL "The inscription is a long one, but in the middle of
it you see the name \"GALFRIDVS CHAVCER.\"" CR>
			<RTRUE>
		)
		(T
			<TELL
"The inscription is written in Latin, but you can make out the name \""
			...
			<COND
				...
				(<EQUAL? 9 .NUM>
					<TELL "Edward V and Richard, Duke of York"> 
				)
				(<EQUAL? 10 .NUM>
...
<ROUTINE RT-READ-PAPER (PAPER-NAME WRITING PHEAT)
	<COND
		...
		(T
			<COND
				(<MC-F? <GETP .PAPER-NAME ,P?FLIPPED>>
...
INDENT "Here comes a chopper" WRAP "to chop off your head." CR
									...
									<PUTP ,TH-PACQUET-OF-PAPER ,P?AUX1
										<BOR <GETP ,TH-PACQUET-OF-PAPER ,P?AUX1> 1>
									>
								)
								(<EQUAL? 2 .WRITING>
									<TELL
...
INDENT "Half a league, half a league." WRAP "Half a league on." CR
									...
									<MC-MAKE .PAPER-NAME ,FL-LOCKED>
									<PUTP ,TH-PACQUET-OF-PAPER ,P?AUX1
										<BOR <GETP ,TH-PACQUET-OF-PAPER ,P?AUX1> 2>
									>
								)
								(<EQUAL? 3 .WRITING>
									<TELL
...
INDENT "I left something for you." WRAP "Go back, if you dare." CR
									...
									<MC-MAKE .PAPER-NAME ,FL-LOCKED>
									<PUTP ,TH-PACQUET-OF-PAPER ,P?AUX1
										<BOR <GETP ,TH-PACQUET-OF-PAPER ,P?AUX1> 4>
									>
								)
							>
							<COND
								(<MC-ISNOT? ,TH-PACQUET-OF-PAPER ,FL-ASLEEP>
									<MC-MAKE ,TH-PACQUET-OF-PAPER ,FL-ASLEEP>
									<RT-UPDATE-SCORE 5>
								)
								(<AND <EQUAL? <GETP ,TH-PACQUET-OF-PAPER ,P?AUX1> 7>
...
<ROUTINE RT-PROCESS-PAPER (PAPER-NAME "AUX" WRITING PHEAT)
	...
	<COND
		(<MC-VERB? TAKE>
			<COND
				(<AND <EQUAL? <LOC .PAPER-NAME> ,TH-ELIZABETH-TOMB ,TH-NEWTON-TOMB ,TH-HENRY-V-TOMB>
						<EQUAL? .WRITING 1 2 3>
					>
					<TELL "You pick at the paper for a few seconds, but it seems
to be stuck to the inscription. After a few seconds you manage to peel
it off." CR>
		...
		(<OR	<AND
			...
			<COND
				(<EQUAL? .PHEAT 1>
					...
					<COND
						(<ZERO? <GETP .PAPER-NAME ,P?FLIPPED>>
		 	   ...
		 	   (<AND <NOT <MC-VERB? LIGHT-WITH BURN-WITH TOUCH-TO>>
					...
					<COND
						(<EQUAL? .WRITING 1 2 3>
							...
							<TELL
" Something seems to be gradually appearing on "
							>
							<COND
								(<ZERO? <GETP .PAPER-NAME ,P?FLIPPED>>
									<TELL "the back of ">
...
writing you could swear hadn't been there before."
					...
					>
					<TELL CR CR "The paper vanishes in a poof of smoke." CR>
		 			<REMOVE .PAPER-NAME>
					<RTRUE>
		 		)
		 	>
		...
		(<MC-VERB? READ EXAMINE>
			<COND
				(<IN? .PAPER-NAME ,TH-PACQUET-OF-PAPER>
					<RT-CYOU-MSG>
...
"cannot do a rubbing while there is something on " THE .PAPER-NAME "." CR
				...
				(T
					...
					<COND
						(<EQUAL? <LOC <LOC .PAPER-NAME>> ,ROOMS>
							<TELL " on ">
							<COND
								(<MC-IS? <LOC .PAPER-NAME> ,FL-INDOORS>
									<TELL THE ,TH-FLOOR>
								)
								(T
									<TELL THE ,TH-GROUND>
...
<ROUTINE RT-I-WESTMINSTER-LIGHTS-ON ()
	...
	<COND
		(<GETP ,CH-PLAYER ,P?IN-ABBEY>
			<TELL "The lights come on." CR>
		)
	>
>

;-----------------------------------------------------------------------------
; "RT-I-WESTMINSTER-LIGHTS-OFF"
;-----------------------------------------------------------------------------
...
to discover that the theft of the jewels has been discovered." CR CR
			>
			<RT-QSR>
		)
	>
...
<ROUTINE RT-PROCESS-BOAT-ON-THAMES ("AUX" UP?)
	<COND
		(<AND <IN? ,TH-ANCHOR ,TH-BOAT>
	...
	>
	<COND
		(<OR	<AND <MC-VERB? EXIT SWIM> <MC-PRSO? ,ROOMS ,TH-BOAT>>
...
"Somehow this doesn't make you feel any better." CR CR
		...
		(<MC-VERB? ROW PADDLE PADDLE-WITH>
			<COND
				...
				(<OR	<MC-PRSO? ,LG-UPSTREAM>
						<MC-PRSO? ,LG-DOWNSTREAM>
						<AND
							<MC-PRSO? ,TH-INTDIR>
							<EQUAL? ,GL-P-DIRECTION ,P?WEST ,P?EAST>
						>
					>
					<SET UP?
						<OR
					...
					<COND
						(<NOT <IN? ,TH-ANCHOR ,TH-BOAT>>
							<RT-CYOU-MSG>
							<TELL
"can " VW " like blue blazes, but the anchor is restraining the boat." CR
							>
						)
						(<AND	<MC-VERB? ROW>
...
"hard on the oar. The boat spins round and round. Wheeeee!" CR
						...
						(<AND <MC-VERB? PADDLE-WITH>
							...
							<COND
								...
								(T
									<RT-CYOU-MSG>
									<TELL "can't paddle with " THEI "." CR>
								)
							>
						)
				...
				(<MC-PRSO? ,TH-INTDIR>
					<RT-ALARM-CLR ,RT-I-MOVE-DOWNSTREAM>
					<TELL
"There doesn't seem to be anything in that direction." CR
					>
					<RTRUE>
				)
				(T
					<RT-ALARM-CLR ,RT-I-MOVE-DOWNSTREAM>
					<TELL
"I don't recognize the direction you are asking me to " VW "." CR
					>
					<RTRUE>
				)
			>
		...
		(<EQUAL? ,TH-GROUND ,GL-PRSO ,GL-PRSI>
			<TELL "There is no " D ,TH-GROUND " in the middle of a river." CR>
		)
	>
>
...
<ROUTINE RT-I-MOVE-DOWNSTREAM ()
	...
	<COND
		(<EQUAL? <LOC ,TH-BOAT>
				,RM-THAMES-ONE ,RM-THAMES-TWO ,RM-THAMES-THREE ,RM-THAMES-FOUR
			>
			<TELL ". ">
		)
	>
...
<ROUTINE RT-THAMES-TIDE ()
	<COND
		(<EQUAL? <RT-CLOCK-CMP  8 32 0 1887 6 18> 1>
			<RETURN 1>
		)
		(<EQUAL? <RT-CLOCK-CMP  8 48 0 1887 6 18> 1>
			<RETURN 0>
		)
		(<EQUAL? <RT-CLOCK-CMP 14 35 0 1887 6 18> 1>
			<RETURN 3>
		)
		(<EQUAL? <RT-CLOCK-CMP 14 51 0 1887 6 18> 1>
			<RETURN 2>
		)
		(<EQUAL? <RT-CLOCK-CMP 20 38 0 1887 6 18> 1>
			<RETURN 1>
		)
		(<EQUAL? <RT-CLOCK-CMP 20 54 0 1887 6 18> 1>
			<RETURN 0>
		)
		(<EQUAL? <RT-CLOCK-CMP  2 41 0 1887 6 19> 1>
			<RETURN 3>
		)
		(<EQUAL? <RT-CLOCK-CMP  2 57 0 1887 6 19> 1>
			<RETURN 2>
		)
		(<EQUAL? <RT-CLOCK-CMP  8 44 0 1887 6 19> 1>
			<RETURN 1>
		)
		(<EQUAL? <RT-CLOCK-CMP  9  0 0 1887 6 19> 1>
			<RETURN 0>
		)
		(<EQUAL? <RT-CLOCK-CMP 14 47 0 1887 6 19> 1>
			<RETURN 3>
		)
		(<EQUAL? <RT-CLOCK-CMP 15  3 0 1887 6 19> 1>
			<RETURN 2>
		)
		(<EQUAL? <RT-CLOCK-CMP 20 50 0 1887 6 19> 1>
			<RETURN 1>
		)
		(<EQUAL? <RT-CLOCK-CMP 21  6 0 1887 6 19> 1>
			<RETURN 0>
		)
		(<EQUAL? <RT-CLOCK-CMP  2 53 0 1887 6 20> 1>
			<RETURN 3>
		)
		(<EQUAL? <RT-CLOCK-CMP  3  9 0 1887 6 20> 1>
			<RETURN 2>
		)
		(<EQUAL? <RT-CLOCK-CMP  8 56 0 1887 6 20> 1>
			<RETURN 1>
		)
		(<EQUAL? <RT-CLOCK-CMP  9 12 0 1887 6 20> 1>
			<RETURN 0>
		)
		(T
			<RETURN 3>
...
; "Passwords for the Tower of London"
...
<ROUTINE RT-TOWER-PASSWORD (WORD-NUM "AUX" PASSWORD)
	<SET PASSWORD <GETP ,CH-MYCROFT-HOLMES ,P?AUX1>>
	<COND
		(<OR	<ZERO? .PASSWORD>
...
Monday morning." CR
		...
		(T
			...
			<RT-UPDATE-SCORE 3>
			<PUTP ,CH-MYCROFT-HOLMES ,P?AUX1 9>
			<RTRUE>
		)
	>
>
...
;*****************************************************************************
; "British Library queue routines"
;*****************************************************************************

;-----------------------------------------------------------------------------
; "RT-I-OPEN-MUSEUM-DOOR"
;-----------------------------------------------------------------------------
