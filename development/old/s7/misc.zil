...
<ROUTINE INTRO ()
	;<TELL "[LEN=" N <LOWCORE SCRV> " WID=" N ,SCREENWIDTH "]">
	 <V-LOOK>
	 <TELL
"Without even a word of farewell, the other members of the team -- Trillian,
Ford Prefect, and Zaphod Beeblebrox -- disappear immediately down onto the
blighted ground north of you, leaving you alone. Or, at least, alone with
Marvin (which is as near to being alone as you can get with a companion).">
	 ;<QUEUE I-NEW-SOFTWARE 2>
	 <CRLF>>
