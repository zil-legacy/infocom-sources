...
<SYNTAX ADDRESS OBJECT (FIND PERSONBIT) (IN-ROOM) = V-TELL PRE-ASK>
...
<SYNTAX TELL OBJECT (FIND PERSONBIT) (IN-ROOM) = V-TELL PRE-ASK>
...
<SYNTAX HEAD OBJECT (FIND ROOMSBIT) = V-WALK>
...
<SYNTAX YELL = V-YELL>
<SYNTAX YELL AT OBJECT (ON-GROUND IN-ROOM EVERYWHERE) = V-TELL PRE-ASK>
<SYNTAX YELL IN OBJECT = V-YELL>
<SYNTAX YELL TO OBJECT (ON-GROUND IN-ROOM EVERYWHERE) = V-TELL PRE-ASK>
