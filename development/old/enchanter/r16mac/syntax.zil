...
<BUZZ A AN THE IS AND OF THEN ALL ONE BUT EXCEPT \. \, \" YES NO Y
      PRY PLEASE HERE LINE LINES YOU SOME>
...
<SYNTAX ATTACK OBJECT (FIND VILLAIN) (ON-GROUND IN-ROOM) = V-ATTACK>
<SYNTAX ATTACK
...
<SYNTAX GONDAR AT OBJECT = V-GONDAR PRE-QUICK-CAST>
<SYNTAX GONDAR ON OBJECT = V-GONDAR PRE-QUICK-CAST>

<SYNTAX GNUSTO OBJECT = V-GNUSTO PRE-QUICK-CAST> ;"write magic"
<SYNTAX GNUSTO AT OBJECT = V-GNUSTO PRE-QUICK-CAST>
<SYNTAX GNUSTO ON OBJECT = V-GNUSTO PRE-QUICK-CAST>

<SYNTAX FROTZ OBJECT = V-FROTZ PRE-QUICK-CAST> ;"light"
<SYNTAX FROTZ AT OBJECT = V-FROTZ PRE-QUICK-CAST>
<SYNTAX FROTZ ON OBJECT = V-FROTZ PRE-QUICK-CAST>

<SYNTAX OZMOO OBJECT = V-OZMOO PRE-QUICK-CAST> ;"resurrect"
<SYNTAX OZMOO AT OBJECT = V-OZMOO PRE-QUICK-CAST>
<SYNTAX OZMOO ON OBJECT = V-OZMOO PRE-QUICK-CAST>

<SYNTAX ZIFMIA OBJECT = V-ZIFMIA PRE-QUICK-CAST> ;"summon"
<SYNTAX ZIFMIA AT OBJECT = V-ZIFMIA PRE-QUICK-CAST>
<SYNTAX ZIFMIA ON OBJECT = V-ZIFMIA PRE-QUICK-CAST>

<SYNTAX VAXUM OBJECT = V-VAXUM PRE-QUICK-CAST> ;"charm"
<SYNTAX VAXUM AT OBJECT = V-VAXUM PRE-QUICK-CAST>
<SYNTAX VAXUM ON OBJECT = V-VAXUM PRE-QUICK-CAST>

<SYNTAX REZROV OBJECT = V-REZROV PRE-QUICK-CAST> ;"open"
<SYNTAX REZROV AT OBJECT = V-REZROV PRE-QUICK-CAST>
<SYNTAX REZROV ON OBJECT = V-REZROV PRE-QUICK-CAST>

<SYNTAX NITFOL OBJECT = V-NITFOL PRE-QUICK-CAST> ;"talk to animal"
<SYNTAX NITFOL AT OBJECT = V-NITFOL PRE-QUICK-CAST>
<SYNTAX NITFOL ON OBJECT = V-NITFOL PRE-QUICK-CAST>

<SYNTAX EXEX OBJECT = V-EXEX PRE-QUICK-CAST> ;"haste"
<SYNTAX EXEX AT OBJECT = V-EXEX PRE-QUICK-CAST>
<SYNTAX EXEX ON OBJECT = V-EXEX PRE-QUICK-CAST>

<SYNTAX KULCAD OBJECT = V-KULCAD PRE-QUICK-CAST> ;"dispel"
<SYNTAX KULCAD AT OBJECT = V-KULCAD PRE-QUICK-CAST>
<SYNTAX KULCAD ON OBJECT = V-KULCAD PRE-QUICK-CAST>

<SYNTAX MELBOR OBJECT = V-MELBOR PRE-QUICK-CAST> ;"protection"
<SYNTAX MELBOR AT OBJECT = V-MELBOR PRE-QUICK-CAST>
<SYNTAX MELBOR ON OBJECT = V-MELBOR PRE-QUICK-CAST>

<SYNTAX BLORB OBJECT = V-BLORB PRE-QUICK-CAST> ;"strong-box"
<SYNTAX BLORB AT OBJECT = V-BLORB PRE-QUICK-CAST>
<SYNTAX BLORB ON OBJECT = V-BLORB PRE-QUICK-CAST>

<SYNTAX GUNCHO OBJECT = V-GUNCHO PRE-QUICK-CAST> ;"banish"
<SYNTAX GUNCHO AT OBJECT = V-GUNCHO PRE-QUICK-CAST>
<SYNTAX GUNCHO ON OBJECT = V-GUNCHO PRE-QUICK-CAST>

<SYNTAX KREBF = V-KREBF PRE-QUICK-CAST> ;"repair damage"
<SYNTAX KREBF OBJECT = V-KREBF PRE-QUICK-CAST>
<SYNTAX KREBF AT OBJECT = V-KREBF PRE-QUICK-CAST>
<SYNTAX KREBF ON OBJECT = V-KREBF PRE-QUICK-CAST>

<SYNTAX CLEESH OBJECT = V-CLEESH PRE-QUICK-CAST>
<SYNTAX CLEESH AT OBJECT = V-CLEESH PRE-QUICK-CAST>
<SYNTAX CLEESH ON OBJECT = V-CLEESH PRE-QUICK-CAST>

<SYNTAX IZYUK OBJECT = V-IZYUK PRE-QUICK-CAST>
<SYNTAX IZYUK AT OBJECT = V-IZYUK PRE-QUICK-CAST>
<SYNTAX IZYUK ON OBJECT = V-IZYUK PRE-QUICK-CAST>

<SYNTAX FILFRE = V-FILFRE PRE-QUICK-CAST>
<SYNTAX FILFRE OBJECT = V-FILFRE PRE-QUICK-CAST>
<SYNTAX FILFRE AT OBJECT = V-FILFRE PRE-QUICK-CAST>
<SYNTAX FILFRE ON OBJECT = V-FILFRE PRE-QUICK-CAST>
