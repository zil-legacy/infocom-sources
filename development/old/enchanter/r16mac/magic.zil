...
"The spell is defaced beyond recognition." CR>
		<RTRUE>)
	       (<FSET? <SET SCROLL <LOC .SPELL>> ,SCROLLBIT>
...
<ROUTINE PLURAL? (N) <COND (<NOT <==? .N 1>> <TELL "s">)>>
...
<GLOBAL NUM-TABLE <TABLE "no" "one" "two" "three" "four">>
...
<ROUTINE V-IZYUK ()
	 <COND (<OR <NOT ,PRSO> <==? ,PRSO ,ME>>
		...
		<TELL
"Your descent slows, and you are floating serenely in mid-air. The tower
