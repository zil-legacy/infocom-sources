...
<ROUTINE FINISH ()
	 ...
	 <V-SCORE>
	 <TELL
"Would you like to start the game again? (Y is affirmative): ">
	 <COND (<YES?> <RESTART>)
	       (T <QUIT>)>>
...
<ROUTINE GOTO (RM "OPTIONAL" (V? T) "AUX" OLIT OHERE)
	 ...
	 <SETG HERE .RM>
	 <SETG LIT <LIT? ,HERE>>
	 <COND (<AND <NOT .OLIT> <NOT ,LIT> <PROB 85>>
		<JIGS-UP
...
paying particular attention to your possessions." CR CR>
	 ...
	 <COND (<NOT <==? ,HERE .RM>> <RTRUE>)
	       (<NOT <==? ,PROTAGONIST ,WINNER>>
		<COND (<AND <NOT <EQUAL? ,HERE ,CLOSET ,ENGINE-ROOM>>
			    <IN? ,PROTAGONIST .OHERE ;"Used to be ,HERE">>
		       <TELL
...
<ROUTINE V-$VERIFY ()
	 ...
	 <COND (<VERIFY> <TELL "Disk correct." CR>)
