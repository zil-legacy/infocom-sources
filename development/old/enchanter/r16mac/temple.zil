...
<ROUTINE TOWER-DOOR-F ()
	 <COND (<AND <VERB? UNLOCK OPEN>
		     ,LOCKED-IN-TOWER>
		<TELL
"The door is locked outside. Even if you could open it, the guards
would undoubtably return you with little difficulty." CR>)
	       (<VERB? KNOCK>
		<TELL
...
They ">
	 <COND (<SETG ANYTHING-TAKEN <BLT ,WINNER ,TOWER-S>>
