...
<CONSTANT NSVERBS 18> "Number of SEEVERBS"
...
<GLOBAL BUZZTABLE:TABLE
	<PTABLE
	 ...
	 <PLTABLE <VOC "ZORK" <>> <VOC "XYZZY" <>> <VOC "GRUE" <>>
		  ...
		  <VOC "MAGICK" <>> <VOC "QUENDOR" <>> <VOC "MONEY" <>>>
...
<ROUTINE ITAKE-CHECK (TBL BITS "AUX" (PTR 1) LEN OBJ L GOT)
	 ...
	 <COND (<ZERO? .LEN>
		...
		<REPEAT ()
			...
			<COND (<AND <NOT <EQUAL? .OBJ ,HANDS ,FEET>>
...
<CONSTANT NTOUCHES 77> "Number of TOUCHVERBS"
...
<GLOBAL TOUCHVERBS:TABLE
	<PTABLE
	 ...
	 V?TURN-TO V?TUNE-TO V?SPIN V?TURN V?SHAKE
...
<CONSTANT NMVERBS 22> "Number of MOVEVERBS."

<GLOBAL MOVEVERBS:TABLE
	<PTABLE
	 V?TAKE V?TAKE-OFF V?MOVE V?PULL V?PUSH V?PUSH-TO V?TURN V?RAISE
	 V?LOWER V?SPIN V?SHAKE V?PLAY V?OPEN V?OPEN-WITH V?CLOSE
	 V?UNTANGLE
