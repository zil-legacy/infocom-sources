...
<ROUTINE V-INVENTORY ("AUX" (WORN? <>) OBJ NXT OLDIT)
	 <COND (<WRONG-WINNER?>
		<RFATAL>)>
...
<ROUTINE COPYRIGHT ()
	 <TELL "Copyright (C)1987 InfoDope, Inc. All rights reserved.">
	 <RTRUE>>

<ROUTINE TRADEMARK ()
	 <ITALICIZE "Beyon Ilf">
	 <TELL " is a trademark of InfoDope, Inc.">
	 <RTRUE>>
...
<ROUTINE NO-MONEY ()
	 <TELL ,DONT "have any money" ,PERIOD>
	 <RTRUE>>
...
<ROUTINE V-LISTEN ("AUX" (OBJ <>))
	 <COND ;(<AND <HERE? IN-ORBIT>
		...
		<TELL ,DONT "hear anything " <PICK-NEXT ,YAWNS> ,PERIOD>
		       <RTRUE>)
	       (T
...
<ROUTINE V-SMELL ("AUX" (OBJ <>))
	 <COND (<PRSO? <> ROOMS>
		<TELL ,DONT "smell anything " <PICK-NEXT ,YAWNS> ,PERIOD>
		<RTRUE>)
	       (T
...
<ROUTINE V-INHALE ()
	 <COND (<NOT <PRSO? ROOMS>>
		<IMPOSSIBLE>
		<RTRUE>)>
	 <TELL "Your attention to detail is unsurpassed." CR>
	 <RTRUE>>
