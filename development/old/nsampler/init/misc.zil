...
<ROUTINE BOOT-SCREEN ()
	 <TELL "WHAT AN UNBELIEVABLE BOOT SCREEN.">
	 <SETG HERE ,TEST-ROOM>
	 <MOVE ,PLAYER ,TEST-ROOM>>
...
<CONSTANT NGVERBS 19> "Number of GAME-VERBS."

<GLOBAL GAME-VERBS:TABLE
	<PTABLE
	 V?INVENTORY ; V?WAIT ; V?WAIT-FOR V?TELL V?SCORE
...
<OBJECT GLOBAL-OBJECTS
	(FLAGS LOCATION LIGHTED INDOORS PLACE FOODBIT
	       ...
	       TOOL VEHBIT READABLE GREETED TOLD
	       BORING SHARPENED MANUALLY WATERY NOGRASS KEYBIT)>
...
<ROUTINE CANT-SEE-MUCH ()
	 <TELL "Little can be seen from where you're standing." CR>
	 <RTRUE>>
...
<OBJECT GENERIC-DOOR   
	(DESC "door")
	(IN LOCAL-GLOBALS)
	(SYNONYM DOOR DOORS DOORWAYS DOORWAY)>
