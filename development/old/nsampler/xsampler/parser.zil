	...
	<COND (,RESERVE-PTR
	      ...
	      (T
	       ...
	       <COND (<NOT <EQUAL? ,VERBOSITY 0>>
		      <CRLF>)>
	       <SETG CLOCK-WAIT <>>              ;"TO FIX RESTART BUG -- TB"
	       <SETG DIGGER-SPOKEN? <>>          ;"HORRIBLE KLUGE."
	       <TELL ">">
	       <READ ,P-INBUF ,P-LEXV>
...
"[There were too many nouns in that sentence.]" CR>
			     ...
			     (<AND <EQUAL? .VERB ,ACT?TELL>
			      ...
			      <TELL
"You can't communicate with other characters that way. Here are some examples of more orthodox ways of talking to people in an Infocom story:|
|
TELL DAVE TO FOLLOW ME|
ASK THE MERCHANT TO TOUCH THE GREEN BASKET|
GARY, TELL ME ABOUT THE UGLY INSECT|
UNCLE HERB, GIVE ME ALL YOUR SOCKS|">
			      <RFALSE>)
			     (T
			      <CANT-USE .PTR>
			      <RFALSE>)>)
...
<ROUTINE NAME? (WRD)
	 <COND ;(<EQUAL? .WRD ,W?TRENT ,W?TIFFAN ,W?TIFF>
		<RTRUE>)
	       (T
		<RFALSE>)>>
...
<BUZZ ASS ASSHOLE BITCH BASTARD COCK COCKSU CUNT DAMN DAMNED FUCK FUCKED FUCKING SHIT SHITHEAD SHITTY>

<ROUTINE NAUGHTY-WORD? (WORD)
         ;<COND (<NOT <EQUAL? ,GAME-FLAG 2>>
		<TELL "[Chastises you.]" CR>
		<RTRUE>)>
	 <COND ;(<NOT <EQUAL? ,NAUGHTY-LEVEL 0>>
		...
		<KNOW-WORD "F">)
	       (<EQUAL? .WORD ,W?SHIT ,W?SHITTY ,W?SHITHEAD>
		<KNOW-WORD "S">)
	       (T
		<RFALSE>)>>
...
"Such language in a high-class establishment like this!" CR>)
		...
		<TELL "[I don't know the " .LETTER "-word.]" CR>)
	       (<EQUAL? ,GAME-FLAG 3>
		<TELL
"[Yes, this story does recognize crudity.]" CR>)
	       (<EQUAL? ,GAME-FLAG 4>
		<TELL "(What charming language.)" CR>)>>
...
;[]			  <COND (<EQUAL? ,RESPONSE 3>
			  ...
			  <COND (<AND .TAKEN
				 ...
				 <COND (<EQUAL? ,WINNER ,PROTAGONIST>
					<TELL ,YNH>)
				       (<EQUAL? ,WINNER ,GRAVEDIGGER>
					<PERFORM ,V?TELL ,GRAVEDIGGER>
					<RTRUE>)
				       (T
					<TELL
