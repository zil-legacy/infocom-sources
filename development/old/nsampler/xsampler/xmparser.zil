...
"[Warning: Only the first word after OOPS is used.]" CR>)>
	...
	<COND (<EQUAL? <GET ,P-LEXV .PTR> ,W?AGAIN ,W?G>
		...
		<COND (<L? <SETG P-LEN <- ,P-LEN 1>> 0>
		       <SETG QUOTE-FLAG <>>
		       <RETURN>)   ;"NEXT clauses added by JO via PROF"
...
<ROUTINE NAME? (WRD)
	 <COND (<OR <EQUAL? .WRD ,W?HARRY ,W?ELSIE ,W?NIMROD>
		    <EQUAL? .WRD ,W?THUMB ,W?COMRAD ,W?CHUCKLES>
		    <EQUAL? .WRD ,W?MUNRAB ,W?HOWARD ,W?WILLIAM>
		    <EQUAL? .WRD ,W?CHELSEA ,W?TAFT ,W?MR>
			      ...
			      (T
			       ...
			       <COND (<NOT <HELD? .OBJ>>
				      ...
				      <COND (<AND .TAKEN <BTST .BITS ,SHAVE>>
					     <COND ;(<OR <EQUAL? .OBJ ,GLOBAL-MONEY ,RIDICULOUS-MONEY-KLUDGE>
						        <AND <==? .OBJ ,INTNUM>
							     ,P-DOLLAR-FLAG>
						        <AND <==? .OBJ ,IT>
						             <EQUAL? ,P-IT-OBJECT ,RIDICULOUS-MONEY-KLUDGE ,INTNUM ,GLOBAL-MONEY>>>
						    <TELL
"You can't afford to.">)
						   (T
						    <TELL "You don't have ">
