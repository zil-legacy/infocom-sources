...
"Talking to yourself is a sign of impending mental collapse." CR>
		...
		<TELL "You are already awake." CR>)
	       (<VERB? EAT>
		<TELL "Auto-cannabilism is not the answer." CR>)
	       (<VERB? EXAMINE>
		<V-DIAGNOSE>)
	       (<AND <VERB? GIVE>
		     <PRSI? ,ME>>
...
<ROUTINE SHOW-DIRECTION? (RM DIR "OPTIONAL" (MAPPING T) "AUX" PTS)
	 <COND (<AND <IN? ,N-S-PASSAGE ,HERE>
		     <NOT <EQUAL? ,HERE ,CONSTRUCTION>>
...
<ROUTINE TOUCHING? (THING)
    <COND (<AND <PRSO? .THING>
		<EQUAL? ,PRSA ,V?BITE ,V?CLEAN ,V?CLIMB ,V?CLIMB-DOWN
			      ...
			      ,V?OPEN ,V?PUSH ,V?RAISE ,V?REACH-IN ,V?SET
			      ,V?SHAKE ,V?STAND-ON ,V?SWIM ,V?TASTE ,V?TAKE
			      ,V?THROW ,V?TIE ,V?TOUCH ,V?UNLOCK>>
	   <RTRUE>)
	  (<AND <PRSI? .THING>
