...
" is now empty." CR>)>)>)
		...
		<COND (<EQUAL? .PRSI-VIAL-GLOOPS 0>
		      ...
		      (<G? .NUM .PRSI-VIAL-GLOOPS>
		       <TELL
"There are only " N .PRSI-VIAL-GLOOPS " gloops in" TR ,PRSI>)
		      (T
		       <PRINT-GLOOP .NUM>
...
<ROUTINE NO-GRADATIONS (VIAL-GLOOPS)
	 <TELL
" as carefully as you can, and it appears to the naked eye that there are now "
N .VIAL-GLOOPS " gloops in the vial. However, since there are no gradations on
