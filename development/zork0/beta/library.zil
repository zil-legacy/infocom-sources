...
for their long journeys to safe havens. The only exit is south.")
      ...
      (SYNONYM LIBRARY)
      (MAP-LOC <PTABLE MAIN-FLOOR-MAP-NUM MAP-GEN-Y-4 MAP-GEN-X-8>)
      (ICON LIBRARY-ICON)
      (ACTION LIBRARY-F)
      (THINGS
<> SNARFEM
...
<> ZAPNERF
"\"Zapnerf is a small wand producer in Foozle, specializing in Wands of
Inanimation.\""
<> (WIZARD FROBOZZ)
...
has always been a favorite spot for wizards who enjoy a hermetic lifestyle.\""
<> KORBOZ
...
scaled this mighty peak.\""
 MICHAEL ( FLATHEAD MICHAEL)
"\"A popular musician, formerly of the Flathead Five.\""
 WURB ( FLATHEAD WURB)
...
Curse destroyed him."
( SAINT ST) ( SAINT BALHU)
"\"The patron saint of circus performers.\""
( SAINT ST) ( SAINT HONKO)
"\"This saint, who lived during the third century, is said to watch over all
people who play very odd musical instruments.\""
( SAINT ST) ( SAINT QUAKKO)
"\"The patron saint of people who aren't sure of things.\""
( SAINT ST) ( SAINT BOVUS)
"\"This saint is said to watch over all those who raise meat animals.\""
( SAINT ST) ( SAINT WISKUS)
"\"This second-century church engineer was canonized for his fine work
with slate patios.\""
<> ( TREATY ZNURG)
...
( OLIVER WENDELL) ( FLATHEAD OLIVER WENDELL)
"\"A noted judge.\""
( FLATHEAD LAKE) ( LAKE FLATHEAD)
...
they start with a lie, sometimes with a truth, buy they always alternate
thereafter.\""
<> PREVARICON
...
produces an annual bounty of grain and is freqently referred to as the
...
meticulous compiled by the Frobozz Magic Encyclopedia Research Company, the
...
<ROUTINE ENCYCLOPEDIA-ENTRY-F ()
    <COND (<VERB? RESEARCH>
	   <PICTURED-ENTRY <GETP ,PRSO ,P?PICTURE> <GETP ,PRSO ,P?RESEARCH>>)>>

<ROUTINE PICTURED-ENTRY (ENC-PIC ENC-TEXT)
	 <CLEAR -1>
	 <SCREEN ,S-FULL>
	 <DISPLAY ,ENCYCLOPEDIA-BORDER 1 1>
	 <PICINF-PLUS-ONE ,ENCYCLOPEDIA-PIC-LOC>
	 <DISPLAY .ENC-PIC <GET ,PICINF-TBL 0> <GET ,PICINF-TBL 1>>
	 <PICINF-PLUS-ONE ,ENCYCLOPEDIA-TXT-LOC>
	 <WINPOS 3 <GET ,PICINF-TBL 0> <GET ,PICINF-TBL 1>>
	 <PICINF ,ENCYCLOPEDIA-TXT-WINDOW-SIZE ,PICINF-TBL>
