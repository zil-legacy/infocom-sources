...
<SYNTAX DEMOLISH OFF OBJECT = V-MUNG>
<VERB-SYNONYM DEMOLISH DESTROY DAMAGE BREAK CRACK SMASH WRECK ;CRUSH ;TRAMPLE>
...
;<SYNTAX SAY = V-SAY>
<SYNTAX SAY OBJECT (EVERYWHERE) = V-SAY ;V-USE-QUOTES>
...
<SYNTAX SING TO OBJECT = V-SING-TO>
<SYNTAX SING OBJECT TO OBJECT = V-SING>
...
<SYNTAX STICK OBJECT (HELD MANY) IN OBJECT (FIND CONTBIT) = V-PUT PRE-PUT>
...
<SYNTAX WEAR OBJECT (FIND WEARBIT) (TAKE MANY HAVE) = V-WEAR>
