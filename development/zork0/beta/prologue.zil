...
<ROOM BANQUET-HALL
      ...
      (SYNONYM HALL)
      (ADJECTIVE BANQUET)
      (MAP-LOC <PTABLE MAIN-FLOOR-MAP-NUM MAP-GEN-Y-3 MAP-GEN-X-6>)
      (ICON BANQUET-HALL-ICON)
      (GLOBAL KITCHEN SCULLERY)
      (ACTION BANQUET-HALL-F)
      (THINGS <> SMOKE SMOKE-PSEUDO
	      <> VAPOR SMOKE-PSEUDO)>

<ROUTINE SMOKE-PSEUDO ()
	 <COND (<VERB? SMELL>
...
<ROOM KITCHEN
      ...
      (MAP-LOC <PTABLE MAIN-FLOOR-MAP-NUM MAP-GEN-Y-3 MAP-GEN-X-7>)
      (ICON KITCHEN-ICON)
      (ACTION KITCHEN-F)>
...
<ROOM SCULLERY
      ...
      (MAP-LOC <PTABLE MAIN-FLOOR-MAP-NUM MAP-GEN-Y-2 MAP-GEN-X-7>)
      (ACTION SCULLERY-F)>

<ROUTINE SCULLERY-F (RARG)
	 <COND (<EQUAL? .RARG ,M-LOOK>
		<TELL
...
<OBJECT DRINKING-STRAW
	...
	(FLAGS TAKEBIT)
	(SIZE 1)
	(ACTION DRINKING-STRAW-F)>

<ROUTINE DRINKING-STRAW-F ()
...
"You see a point of light: the far end of the straw." CR>)>)
	       (<AND <VERB? SUCK-WITH>
		     <PRSI? ,DRINKING-STRAW>>
		<PERFORM ,V?DRINK-WITH ,PRSO ,DRINKING-STRAW>
		<RTRUE>)
	       (<VERB? SUCK-ON>
		...
		<TELL ". Wow." CR>)
	       (<AND <VERB? TAKE>
		     ,FINGER-ON-STRAW
		     ,ELIXIR-TRAPPED
		     <IN? ,DRINKING-STRAW ,BOWL>>
		<SETG FINGER-ON-STRAW <>>
		<SETG ELIXIR-TRAPPED <>>
		<MOVE ,DRINKING-STRAW ,PROTAGONIST>
		<TELL
...
the cellar lies to the north.")
      ...
      (ADJECTIVE ROOT)
      (GLOBAL STAIRS)
      (MAP-LOC <PTABLE MAIN-FLOOR-MAP-NUM MAP-GEN-Y-3 MAP-GEN-X-8>)>

<OBJECT UNOPENED-WALNUT
...
"This is one tough shell. You can't seem to crack it with your ">
		      ...
		      (<AND <PRSI? ,LOBSTER>
		       ...
		       <COND (<VISIBLE? ,JESTER>
			      ...
			      <SETG WALNUT-OPENED T>)>
		       <MOVE ,WALNUT-SHELL <LOC ,UNOPENED-WALNUT>>
		       <MOVE ,WALNUT ,WALNUT-SHELL>
		       <THIS-IS-IT ,WALNUT>
		       <REMOVE ,UNOPENED-WALNUT>
		       <TELL
...
"This succeeds in crushing the shell (and its contents) to dust." CR>)
	       ...
	       (<AND <VERB? PUT-ON>
		     <PRSI? ,UNOPENED-WALNUT>
		     <G? <GETP ,PRSO ,P?SIZE> 14>>
		<PERFORM ,V?MUNG ,UNOPENED-WALNUT ,PRSO>
		<RTRUE>)
	       (<AND <VERB? STAND-ON>
		     <NOT <FSET? ,UNOPENED-WALNUT ,OPENBIT>>>
		<TELL
...
<OBJECT WALNUT-SHELL
	...
	(SIZE 1)
	(ACTION WALNUT-SHELL-F)>

<ROUTINE WALNUT-SHELL-F ()
	 <COND (<VERB? CLOSE>
		<TELL
...
Stone stairs lead upward, and the cellar continues to the south.")
      ...
      (ADJECTIVE WINE)
      (GLOBAL STAIRS)
      (MAP-LOC <PTABLE MAIN-FLOOR-MAP-NUM MAP-GEN-Y-2 MAP-GEN-X-8>)
...
"Dimwit is seated at the dais, surrounded by his most trusted advisors.")
	...
	(FLAGS NARTICLEBIT NDESCBIT ACTORBIT)
...
<ROUTINE GENERIC-DIMWIT-F (TBL F)
...
be affected, however.">)>
		<COND (<IN? ,JESTER ,HERE>
		       <REMOVE-JESTER>
		       <TELL " In addition, the jester has vanished.">)>
		<CRLF>
...
<ROUTINE PUT-ITEM-IN-CAULDRON (OBJ "AUX" X N (CAULDRON-SCORE 0))
	 ...
	 <COND (<FSET? .OBJ ,MAGICBIT>
		...
		<FCLEAR .OBJ ,ONBIT>
 		<QUEUE I-CAULDRON-REGURGITATE 3>
		<COND (<NOT <AND <EQUAL? .OBJ ,WALNUT>
			    	 <IN? ,WALNUT ,UNOPENED-WALNUT>>>
		       <MOVE .OBJ ,MEGABOZ>)>
		<COND (<PRSO? ,PERCH>
...
<ROUTINE I-CAULDRON-REGURGITATE ("AUX" X (TWO <>))
...
"   An angry wizard stands defiantly in the center of the hall.">
		<COND (<NOT <FSET? ,PARCHMENT ,NDESCBIT>>
		       <TELL
