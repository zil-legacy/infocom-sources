...
"Would you like to start over, restore a saved position, ">
	       ...
	       <TELL
"end this session of the game, or get a hint?|
(Type RESTART, RESTORE, ">
	       <COND (<NOT <EQUAL? ,HERE ,ROOM-OF-THREE-DOORS>>
		      <TELL "UNDO, ">)>
	       <TELL "QUIT, or HINT): >">
	       <PUTB ,P-LEXV 0 10>
...
ZORK ZERO is a trademark of Infocom, Inc." CR>
	 <INTERPRETER-ID>
...
<ROUTINE INTERPRETER-ID () ;"changed 7/21/88 per mail from TAA"
	 <TELL
"Interpreter " N <LOWCORE INTID> ", Version " N <LOWCORE ZVERSION>
"." N <LOWCORE INTVR> CR>>
...
<ROUTINE V-$REFRESH ("OPTIONAL" (DONT-CLEAR <>))
	 <COND (.DONT-CLEAR ;"the screen"
		...
		<INIT-SL-WITH-SPLIT ,CURRENT-SPLIT T>)
	       (T
		<INIT-STATUS-LINE>)>
	 <COND (<EQUAL? ,P-CAN-UNDO 2> ;"clear the chess-piece-move table"
		<SETG DIR-CNT 0>)>
	 <COND (<EQUAL? ,CURRENT-SPLIT ,BOZBAR-SPLIT>
		<DRAW-TOWER>)
	       (<EQUAL? ,CURRENT-SPLIT ,PEGGLEBOZ-SPLIT>
		<SETUP-PEGGLEBOZ>)
	       (<EQUAL? ,CURRENT-SPLIT ,SNARFEM-SPLIT>
		<SETUP-SNARFEM>)
...
<ROUTINE V-$SKIP ()
	 <COND (<NOT ,PRSO>
		...
		<MOVE ,DRINKING-STRAW ,SCULLERY>
		<ROB ,PROTAGONIST>
	 	<REMOVE ,DIMWIT>
	 	<REMOVE ,MEGABOZ>
	 	<MOVE ,UNOPENED-WALNUT ,ROOT-CELLAR>
	 	...
	 	<SETG UNDER-TABLE <>>
	 	<SETG MIDDLE-NAME-NUMBER <- <RANDOM 12> 1>>
	 	<PUT <GETPT ,MIDDLE-NAME-OBJECT ,P?SYNONYM>
		     0
		     <GET ,MIDDLE-NAME-WORDS ,MIDDLE-NAME-NUMBER>>
		...
		<COND (<PRSO? ,CAULDRON>
		       ...
		       <MOVE ,EASLE ,HERE>
		       <MOVE ,LANDSCAPE ,HERE>)
		      (<PRSO? ,TOWER-OF-BOZBAR>
		       <GOTO ,JESTERS-QUARTERS>)
		      (<PRSO? ,PEGGLEBOZ-OBJECT>
		       <GOTO ,PEG-ROOM>)
		      (<PRSO? ,DOUBLE-FANUCCI>
		       <GOTO ,CASINO>)
		      (<PRSO? ,HOTHOUSE>
...
certainly wouldn't walk into YOUR home and start spewing phlegm around!\"">
		       <COND (<IN? ,JESTER ,HERE>
			      <REMOVE-JESTER>
			      <TELL CR
"   They notice the jester for the first time." ,WITCH-REMOVES-JESTER>)
			     (T
			      <CRLF>)>)
		      (T
		       <TELL
...
future will begin their tales of your quest." CR>>
...
since I had" A ,PRSO ".\" ">
		       ...
		       <COND (<AND <PRSO? ,PIGEON>
			      ...
			      <CHESS-PIECE-TAKES-PERCH .CHESSPIECE>)
			     (T
			      <CRLF>)>)
...
<ROUTINE JUMPLOSS ()
	 <COND (<EQUAL? ,HERE ,PARAPET ,UPPER-LEDGE ,LOWER-LEDGE
			      ,G-U-MOUNTAIN ,BALCONY ,ROOF>
		<COND (<PROB 33>
		       <TELL "Geronimo">)
		      (<PROB 50>
		       <TELL "You should have looked before you leapt">)
		      (T
		       <TELL "This was not a very place to try jumping">)>
		<JIGS-UP "!">)
	       (T
		<RFALSE>)>>
...
<ROUTINE V-LISTEN ()
	 <COND (,PRSO
		...
		<TELL
"You hear a loud, regular, extremely annoying ticking sound." CR>)
...
<ROUTINE V-MAP (TBL MAP-NUM RM "AUX" RM-ICON CX CY)
	 <COND (,DEBUG
		<SET RM <FIRST? ,ROOMS>>
		<REPEAT ()
			<COND (<NOT .RM>
	 ...
	 <COND (<AND <EQUAL? ,HERE ,GONDOLA>
		...
		<TELL
"says, \"It may seem odd and it may seem queer, but on-line mapping
...
already done so. Are you ready to see the map (y or n)? >">
	 ...
	 <SET RM <FIRST? ,ROOMS>>
	 <DRAW-TITLES-AND-SPECIAL-CASES .MAP-NUM>
	 <REPEAT ()
	    <COND (<NOT .RM>
		   <RETURN>)>
	    <COND (<SET TBL <GETP .RM ,P?MAP-LOC>> ;"not all rooms go on a map"
		   <COND (<AND <EQUAL? <GET .TBL 0> .MAP-NUM>
				   ...
				   <AND <EQUAL? .RM ,FROBOZZCO-OFFICES
						,OFFICES-NORTH ,OFFICES-SOUTH
						,OFFICES-EAST ,OFFICES-WEST>
					,BEEN-IN-FROBOZZCO-UPPER-FLOORS>>>
			  <COND (<AND <DELTA? .RM>
				      <NOT <FIRST? .RM>>>
				 T)
	 ...
	 <DISPLAY ,MAP-ROSE-BACKGROUND <GET ,PICINF-TBL 0> <GET ,PICINF-TBL 1>>
	 <PICINF-PLUS-ONE ,MAP-COMPASS-PIC-LOC>
	 <DRAW-COMPASS-ROSE ,P?NORTH ,MAP-N-HIGHLIGHTED ,MAP-N-UNHIGHLIGHTED>
	 <DRAW-COMPASS-ROSE ,P?NE ,MAP-NE-HIGHLIGHTED ,MAP-NE-UNHIGHLIGHTED>
	 <DRAW-COMPASS-ROSE ,P?EAST ,MAP-E-HIGHLIGHTED ,MAP-E-UNHIGHLIGHTED>
	 <DRAW-COMPASS-ROSE ,P?SE ,MAP-SE-HIGHLIGHTED ,MAP-SE-UNHIGHLIGHTED>
	 <DRAW-COMPASS-ROSE ,P?SOUTH ,MAP-S-HIGHLIGHTED ,MAP-S-UNHIGHLIGHTED>
	 <DRAW-COMPASS-ROSE ,P?SW ,MAP-SW-HIGHLIGHTED ,MAP-SW-UNHIGHLIGHTED>
	 <DRAW-COMPASS-ROSE ,P?WEST ,MAP-W-HIGHLIGHTED ,MAP-W-UNHIGHLIGHTED>
	 <DRAW-COMPASS-ROSE ,P?NW ,MAP-NW-HIGHLIGHTED ,MAP-NW-UNHIGHLIGHTED>
	 <SET TBL <GETP ,HERE ,P?MAP-LOC>>
	 <SET CY <MAP-Y <ZGET .TBL 1>>>
	 <SET CX <MAP-X <ZGET .TBL 2>>>
	 <BLINK-WHILE-AWAITING-INPUT
	        <COND (<SET RM-ICON <GETP ,HERE ,P?ICON>>
		       .RM-ICON)
		      (T
		       ,ICONLESS-ROOM-BOX)>
...
<ROUTINE DRAW-TITLES-AND-SPECIAL-CASES (MAP-NUM "AUX" TMP TMP1)
	 <COND (<EQUAL? .MAP-NUM ,MAIN-FLOOR-MAP-NUM>
		<DISPLAY-ROOM ,MAIN-FLOOR-TITLE
			      ,MAIN-FLOOR-TITLE-LOC ,MAIN-FLOOR-TITLE-LOC>
		...
		<COND (<FSET? ,LOWER-HALL ,TOUCHBIT>
	       ...
	       (<EQUAL? .MAP-NUM ,LAKE-AREA-MAP-NUM>
	 	<DISPLAY-ROOM ,LAKE-AREA-TITLE
			      ,LAKE-AREA-TITLE-LOC ,LAKE-AREA-TITLE-LOC>
	 	...
	 	<COND (<FSET? ,UNDERWATER ,TOUCHBIT>
	        ...
	        <COND (<FSET? ,GROTTO ,TOUCHBIT>
		       <DISPLAY-ROOM ,N-S-CONNECTION ,MAP-GEN-Y-4 ,MAP-GEN-X-7>
		       <SET TMP <MAP-Y ,5-FUDGE>>
		       <DISPLAY-ROOM ,N-S-CONNECTION
		...
		<DISPLAY-ROOM ,HORIZONTAL-LEGEND ,MAP-GEN-Y-3 ,MAP-GEN-X-8>)
	       (<EQUAL? .MAP-NUM ,PORT-FOOZLE-MAP-NUM>
	 	<DISPLAY-ROOM ,PORT-FOOZLE-TITLE ,MAP-GEN-Y-1 ,MAP-GEN-X-2>
	 	<DISPLAY-ROOM ,VERTICAL-LEGEND ,MAP-GEN-Y-1 ,MAP-GEN-X-10>
	 	<DISPLAY-ROOM ,PORT-FOOZLE-MAP-ILL ,MAP-GEN-Y-6 ,MAP-GEN-X-8>
		...
		<COND (<FSET? ,CAVE-IN ,TOUCHBIT>
		       <DISPLAY-ROOM ,E-W-CONNECTION ,MAP-GEN-Y-3
				     ,MAP-GEN-X-8 0 ,MAP-BOX-WIDTH>)>
	 	<COND (<FSET? ,FISSURE-EDGE ,TOUCHBIT>
		       <DISPLAY-ROOM ,N-S-CONNECTION ,MAP-GEN-Y-4
		...
		<COND (<AND <FSET? ,CRAG ,TOUCHBIT>
		       ...
		       <DISPLAY-ROOM ,ARCH-N-CONNECTOR
				     ,MAP-GEN-Y-4 ,MAP-GEN-X-4
				     <+ <- <MAP-Y ,ARCH-N-CONNECTOR-SIZE>> 1>
				     ,MAP-BOX-WIDTH>
		       <DISPLAY-ROOM ,ARCH-S-CONNECTOR
				     ,MAP-GEN-Y-4 ,MAP-GEN-X-4
				     ,MAP-BOX-HEIGHT
				     ,MAP-BOX-WIDTH>)>)
		...
		<COND (<AND <FIRST? ,DELTA-2>
			    <FIRST? ,DELTA-7>>
		       <DISPLAY-ROOM ,RUBBLE-SE-CONNECTOR
		...
		<COND (<AND <FIRST? ,DELTA-2>
		       ...
		       <DISPLAY-ROOM ,DELTA-2-3-CON
				     ...
				     <+ <- <MAP-X ,2-3-CONNECTOR-SIZE>> 1>>)>
		<COND (<AND <FIRST? ,DELTA-3>
			    <FIRST? ,DELTA-4>>
		       <DISPLAY-ROOM ,RUBBLE-NW-CONNECTOR
				    ,MAP-GEN-Y-3 ,MAP-GEN-X-9
				    <- <- <MAP-Y ,RUBBLE-CONNECTOR-SIZE>> 1>
				    <- <- <MAP-X ,RUBBLE-CONNECTOR-SIZE>> 1>>)>
		<COND (<AND <FIRST? ,DELTA-3>
			    <FIRST? ,DELTA-5>>
		       <DISPLAY-ROOM ,DELTA-3-5-CON
				     ,MAP-GEN-Y-2 ,MAP-GEN-X-8
				     ,MAP-BOX-HEIGHT
				     <+ <- <MAP-X ,3-5-CONNECTOR-SIZE>> 1>>)>
		...
		<COND (<AND <FIRST? ,DELTA-5>
		       ...
		       <DISPLAY-ROOM ,DELTA-5-6-CON
				     ,MAP-GEN-Y-2 ,MAP-GEN-X-7
				     ,MAP-BOX-HEIGHT
				     <+ <- <MAP-X ,5-6-CONNECTOR-SIZE>> 1>>)>
		<COND (<AND <FIRST? ,DELTA-6>
			    <FSET? ,DELTA-6 ,TOUCHBIT>
			    <FIRST? ,DELTA-7>>
		       <DISPLAY-ROOM ,DELTA-6-7-CON
				     ,MAP-GEN-Y-5 ,MAP-GEN-X-7
				     0 <- <MAP-X ,6-7-CONNECTOR-SIZE>>>)>)
	       (<EQUAL? .MAP-NUM ,FUBLIO-VALLEY-MAP-NUM>
	 	<DISPLAY-ROOM ,FUBLIO-VALLEY-TITLE ,MAP-GEN-Y-2 ,MAP-GEN-X-9>
	 ...
	 <COND (<FSET? ,PRSI ,WATERBIT>
		...
		<TELL T ,PRSI " for" TR ,PRSO>)
	       (<AND <NOT <ULTIMATELY-IN? ,PRSO>>
		     <EQUAL? <ITAKE> ,M-FATAL <>>>
		<RTRUE>)
	       (<AND <EQUAL? ,HERE ,MARSH ,NICE-LUNCH-SPOT>
		     <NOT ,ARCHWAY-OPEN>
		     <PRSO? ,FOX ,ROOSTER ,WORM>>
...
<ROUTINE V-ROLL-DIR ("AUX" OHERE)
	 <COND ;(<NOT <PRSI? ,INTDIR>>
		...
		<COND (<NOT <EQUAL? ,HERE .OHERE>>
		       <MOVE ,DUMBBELL ,HERE>
		       <TELL "   The dumbbell rolls to a stop." CR>)>
		<RTRUE>)
	       (T
		<V-ROLL>)>>
...
<ROUTINE V-SACRED-WORD ()
	 <COND (<AND <NOT <EQUAL? ,SACRED-WORD-NUMBER 10>> ;"haven't seen word"
		...
		<FCLEAR ,PERIMETER-WALL ,TOUCHBIT>
		<QUEUE I-END-GAME -1>
		<TELL
"As you utter the sacred word, time resumes it's normal motion! ">
...
<ROUTINE V-NOT-SO-SACRED-WORD ()
	 <TELL
"The word hangs in the air like a damp fog before disappating." CR>>
...
and right on the money!\"">
	       ...
	       (<AND <EQUAL? ,HERE ,CAVE-IN>
		     ...
		     <IN? ,JESTER ,HERE>>
		<COND (<OR <PRSO? ,MIDDLE-NAME-OBJECT>
			   <EQUAL? .V
				 <GET ,MIDDLE-NAME-WORDS ,MIDDLE-NAME-NUMBER>>>
		       <MOVE ,PIT-BOMB ,HERE>
		       <TELL
...
<ROUTINE V-SCORE ()
	 ...
	 <COND (<EQUAL? ,SCORE 1000>
		...
		<TELL "Peasant">)>
	 <TELL
". [MAXINTS = " N <- 60 ,C-MAXINTS> ". Testers: please report the highest
value of this number each time you play!]" CR>>
	 ...
	 <COND (<AND ,TURNED-INTO
		...
		<RFALSE>)
	       (<AND <PLANT? ,PRSO>
		     ,PLANT-TALKER>
		<RFALSE>)
	       (<AND <PRSO? ,OTHER-JESTER-NAMES ,MIDDLE-NAME-OBJECT>
		     <VISIBLE? ,JESTER>>
		<SETG PRSO ,JESTER>
		<RFALSE>)
	       (<PRSO? ,OTHER-JESTER-NAMES ,MIDDLE-NAME-OBJECT>
		<TELL ,NO-ONE-HERE>
		<STOP>)
		...
		<DO-FIRST "get out from under the table">)
	       (<AND <FSET? .AV ,VEHBIT>
		     ...
		     <NOT <AND <EQUAL? .AV ,CAMEL>
			       <FSET? ,CAMEL ,ANIMATEDBIT>>>>
		<COND (<AND <EQUAL? .AV ,BATHYSPHERE>
			    <PRSO? ,P?UP>
			    <NOT <EQUAL? ,HERE ,HOLD>>>
		       <PERFORM ,V?RAISE ,UP-DOWN-LEVER>
		       <RTRUE>)
		      (<AND <EQUAL? .AV ,BATHYSPHERE>
			    <PRSO? ,P?DOWN>
			    <NOT <EQUAL? ,HERE ,LAKE-BOTTOM>>>
		       <PERFORM ,V?LOWER ,UP-DOWN-LEVER>
		       <RTRUE>)>
...
<ROUTINE CANT-GO ()
	 <COND (<AND <NOT ,LIT>
		     <NOT <EQUAL? <LOC ,PROTAGONIST> ,BATHYSPHERE ,HOLD>>
		     <NOT ,TIME-STOPPED>
		     <PROB 75>>
		<DARK-DEATH>)
...
"You're already juggling as many items as you could possibly carry." CR>)>
		...
		<COND (.VB
		       <COND (<FSET? .OBJ ,PLURALBIT>
			     ...
			     (T
			      <TELL "It's">)>
		       <TELL " too heavy, considering your current load." CR>)>
		<RFATAL>)>
	 <FSET .OBJ ,TOUCHBIT>
	 <FCLEAR .OBJ ,NDESCBIT>
...
<ROUTINE IDROP ()
	 <COND (<PRSO? ,ROOMS> ;"input was LET GO"
		<COND (<EQUAL? ,HERE ,HANGING-FROM-ROOTS>
		       <PERFORM ,V?LEAP>
		       <RTRUE>)
		      (T
...
<ROUTINE D-ROOM ("OPTIONAL" (VERB-IS-LOOK <>) "AUX" (FIRST-VISIT <>) PIC)
	 ...
	 <COND (<OR .VERB-IS-LOOK
		...
		<CRLF>)>
	 <COND (<NOT <EQUAL? ,HERE ,CONSTRUCTION ,FROBOZZCO-OFFICES
			     ,PLAIN ,OFFICES-NORTH ,OFFICES-SOUTH
			     ,OFFICES-EAST ,OFFICES-WEST>>
		<FSET ,HERE ,TOUCHBIT>)>
	 <RTRUE>>
...
<ROUTINE HOLDING-GLOOPS (NUM)
	 <TELL " (holding " N .NUM " gloop">
...
<ROUTINE GOTO (NEW-LOC "AUX" OHERE OLIT BORDER)
	 <SETG JUMP-X 99>
	 <SETG JUMP-Y 99>
...
" The " D .TAKER " is only too happy to pick it all up">
	     <COND (<AND .TOOK-PIGEON
		    ...
		    <CHESS-PIECE-TAKES-PERCH ,PRSI <> ;"no CR">)
		   (T
		    <TELL ".">)>)>
       <RTRUE>>
