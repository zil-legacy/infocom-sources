...
<INCLUDE "BASEDEFS" "PDEFS"> ;"needed for GENERIC-VIAL-F, for some reason"
...
crevices. A stream of slime drips sluggishly down an uneven tunnel which
heads roughly upwards.")
      (UP TO CRYPT)
      (OUT TO CRYPT)
...
<OBJECT ORACLE-OBJECT
	...
	(FLAGS VOWELBIT VEHBIT INBIT CONTBIT OPENBIT SEARCHBIT DROPBIT)
	(CAPACITY 100)
	(RESEARCH
...
offered bits of wisdom and could transport believers to distant regions.")
	(DESCFCN ORACLE-OBJECT-F)
	(ACTION ORACLE-OBJECT-F)>

<ROUTINE ORACLE-OBJECT-F ("OPTIONAL" (OARG <>))
	 <COND (.OARG
		<COND (<NOT <EQUAL? .OARG ,M-OBJDESC ,M-OBJDESC?>>
		       <RFALSE> ;"it's also a vehicle")
		      (T
...
were just wild fictions.">)>
		...
		<COND (<IN? ,RUBY ,DEPRESSION>
		       <MOVE ,PRSO <GET ,ORACLE-TABLE ,ORACLE-EXIT-NUMBER>>
...
<ROUTINE DESCRIBE-ORACLE ()
	 <TELL
"Before you sits the legendary Oracle of Bargth. Shaped like an enormous
serpent's head, its huge mouth hangs open in an expression of insatiable
hunger; its four ">
	 <COND (<IN? ,RUBY ,DEPRESSION>
		<TELL "glowing">)
	       (T
...
a stunningly beautiful sapphire.")
	(SYNONYM SAPPHIRE JEWEL JERRIMOOR)
...
<ROUTINE STATUE-F ()
	 <COND (<AND <VERB? PUT-ON>
		...
		<TELL ,STATUE-DESC CR>)
	       (<VERB? ALARM>
		<TELL
"Apparent, you think breaking an enchantment is as easy as breaking an
egg!" CR>)>>
...
like a finger at the very edge of the ledge. A steep path climbs further up
...
<ROUTINE GENERIC-PAINTING-F (SRES F)
	 ,LANDSCAPE>
...
<ROUTINE MIRROR-LAKE-F (RARG "AUX" TMP DIR)
...
amulet -- and the mirror goes blank!" CR>)
		      (<PRSO? ,CANDLE>
		       <TELL
"A flurry of images surround the candle's reflection: an aged wizard weaving
...
hunched over a small checkered board." CR>)
		      ...
		      (T
		       ...
		       <TELL
"The reflection of" T ,PRSO " looks just like" T ,PRSO " itself." CR>)>)
	       (<VERB? MUNG>
		<JIGS-UP
...
<ROUTINE NORTH-OF-MIRROR-F (RARG)
	 <COND (<EQUAL? .RARG ,M-LOOK>
...
<ROUTINE SOUTH-OF-MIRROR-F (RARG)
	 <COND (<EQUAL? .RARG ,M-LOOK>
...
<ROOM FOOT-OF-STATUE
      ...
      (VALUE 10)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-4 MAP-GEN-X-8>)
      (ICON FOOT-OF-STATUE-ICON)
      (ACTION FOOT-OF-STATUE-F)>

<ROUTINE FOOT-OF-STATUE-F (RARG)
	 <COND (<EQUAL? .RARG ,M-LOOK>
		<TELL
...
<ROOM VIEW-OF-STATUE
      ...
      (FLAGS RLANDBIT OUTSIDEBIT ONBIT BEYONDBIT)
      (GLOBAL DIMWIT-STATUE)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-5 MAP-GEN-X-7>)
      (ACTION VIEW-OF-STATUE-F)>

<ROUTINE VIEW-OF-STATUE-F (RARG)
	 <COND (<EQUAL? .RARG ,M-LOOK>
		<TELL
...
"A trail from the north ends here. To the west is a decaying hut.")
      ...
      (FLAGS RLANDBIT OUTSIDEBIT ONBIT BEYONDBIT)
      (GLOBAL MEGABOZ-HUT)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-6 MAP-GEN-X-7>)
...
<ROOM MEGABOZ-HUT
      ...
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-6 MAP-GEN-X-6>)
      (ACTION MEGABOZ-HUT-F)>

<ROUTINE MEGABOZ-HUT-F (RARG)
	 <COND (<EQUAL? .RARG ,M-LOOK>
		<TELL
...
the hut.")
      ...
      (VALUE 8)
      (SYNONYM ATTIC)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-6 MAP-GEN-X-5>)
      (ICON ATTIC-ICON)>
...
<OBJECT TRUNK
	...
	(DESC "trunk")
	(LDESC
"In the shadows under the eaves, you spot a ancient trunk, covered with
dust and cobwebs.")
	(SYNONYM TRUNK)
...
and south.")
      ...
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-6 MAP-GEN-X-8>)
      (ICON CAIRN-ICON)>
...
entrance, and a path runs off to the west.")
      ...
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-6 MAP-GEN-X-9>)>
...
only exit is southwest.")
      ...
      (SYNONYM SHACK)
      (ADJECTIVE GUMBOZ\'S)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-5 MAP-GEN-X-10>)
      (ACTION GUMBOZ-SHACK-F)>

<ROUTINE GUMBOZ-SHACK-F (RARG "AUX" (SPILL <>))
...
age, and its drooping branches cast a dark shadow across the quarry below.")
      ...
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-7 MAP-GEN-X-8>)
...
of this old stone quarry.")
      ...
      (GLOBAL TIRED-PINE)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-7 MAP-GEN-X-7>)
      (ICON QUARRY-ICON)
      (ACTION QUARRY-F)>

<ROUTINE QUARRY-F (RARG)
...
hovel's entrance, to the east, is a faded sign.")
      ...
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-7 MAP-GEN-X-9>)>
...
only exit is west.")
      ...
      (SYNONYM HOVEL)
      (ADJECTIVE KORBOZ\'S)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-7 MAP-GEN-X-10>)>
...
and north into the foothills.")
      ...
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-5 MAP-GEN-X-6>)
...
the south.")
      ...
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-4 MAP-GEN-X-6>)>
...
map, but you have still not reached the highest point of the pass.")
      ...
      (UP TO AVALANCHE)
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-3 MAP-GEN-X-5>)
...
avalanche. Though you can travel no further to the northwest, the avalanche
has revealed an ancient ravine leading up the side of the mountain.")
      ...
      (SE TO ZORBEL-PASS)
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-2 MAP-GEN-X-4>)
      (ICON AVALANCHE-ICON)>
...
shroud the apex of Foobia.")
      ...
      (DOWN TO AVALANCHE)
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-2 MAP-GEN-X-3>)
...
slope continues to be climbable above you. Breathing here is a chore.")
      ...
      (DOWN TO TIMBERLINE)
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-2 MAP-GEN-X-2>)
...
the toe.")
      ...
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (GLOBAL BROGMOID)
      (MAP-LOC <PTABLE FUBLIO-VALLEY-MAP-NUM MAP-GEN-Y-2 MAP-GEN-X-1>)
...
<ROUTINE LITTLE-FUNGUS-F ("OPTIONAL" (ARG <>))
	 <COND (<IN? ,PRSO ,GLOBAL-OBJECTS>
		<COND (<AND <VERB? CALL YELL SAY FIND>
		      ...
		      (<HANDLE ,LITTLE-FUNGUS-F>
		       <CANT-SEE ,LITTLE-FUNGUS>)>)
	       (<EQUAL? .ARG ,M-WINNER>
		<PLANT-STUNNED>)
	       (<OR <AND <VERB? DROP>
			 <EQUAL? ,HERE ,EAR>>
		    <AND <VERB? GIVE PUT PUT-ON>
			 <PRSI? ,EAR-FUNGUS>>
		    <AND <VERB? PUT PUT-ON>
			 <PRSI? ,BROGMOID>
...
<ROOM EDGE-OF-BOG
      ...
      (DESC "Edge of Bog")
      (LDESC
"A series of flat stones lead east into a mist-covered marsh. Paths lead
northwest and west.")
...
stadium; to the southwest, a town. A path leads east into a hollow.")
      ...
      (EAST TO AERIE)
      (FLAGS RLANDBIT ONBIT BEYONDBIT OUTSIDEBIT)
      (GLOBAL SWAMP FLATHEAD-OCEAN FLATHEAD-STADIUM GLOBAL-BUILDING)
...
<ROUTINE AERIE-F (RARG "AUX" OBJ OWINNER)
	 <COND (<AND <EQUAL? .RARG ,M-END>
...
<ROUTINE WITCH-F ("OPT" (ARG <>))
	 <COND (<EQUAL? .ARG ,M-WINNER>
		<COND (<FSET? ,BAT ,TRYTAKEBIT>
		       <TELL
"\"Bring us exactly six gloops of water from the Great Underground Oasis,
...
<ROUTINE GENERIC-VIAL-F (SRES F)
	 <COND (<EQUAL? <GET <REST-TO-SLOT <FIND-ADJS .F> ADJS-COUNT 1> 0>
			,W?INT.NUM>
		<COND (<EQUAL? ,P-NUMBER 4>
		       ,SMALL-VIAL)
		      (<EQUAL? ,P-NUMBER 9>
		       ,LARGE-VIAL)
		      (T
		       <TELL
,YOU-CANT-SEE-ANY N ,P-NUMBER "-gloop vial here!]" CR>
		       <RTRUE>)>)>>
...
<ROUTINE VIAL-F ("AUX" NUM VIAL-GLOOPS)
	 <COND (<PRSO? ,SMALL-VIAL>
		<SET VIAL-GLOOPS ,SMALL-VIAL-GLOOPS>)
	       (T
		<SET VIAL-GLOOPS ,LARGE-VIAL-GLOOPS>)>
	 <COND (<VERB? EXAMINE LOOK-INSIDE>
		<TELL "The vial ">
		<COND (<EQUAL? .VIAL-GLOOPS 0>
		       <TELL "is empty">)
		      (T
		       <TELL "contains ">
...
fingers, missing your rump by inches as you scurry from the cave." CR CR>
		...
		<COND (<PRSI? ,WATER>
		       ...
		       <TELL "You fill the vial to the brim." CR>)
		      (<AND <PRSO? ,SMALL-VIAL>
			    <PRSI? ,LARGE-VIAL>>
...
" is now empty." CR>)>)>)
	       (<AND <VERB? EMPTY-FROM>
		     <PRSO? ,WATER>>
		<COND (<SET NUM <NP-ADJS <GET-NP ,PRSO>>>
		...
		<COND (<EQUAL? .VIAL-GLOOPS 0>
		      ...
		      (<G? .NUM .VIAL-GLOOPS>
		       <TELL
"There are only " N .VIAL-GLOOPS " gloops in" TR ,PRSO>)
		      (T
		       <PRINT-GLOOP .NUM>
		       <SET VIAL-GLOOPS <- .VIAL-GLOOPS .NUM>>
		       <COND (<EQUAL? .VIAL-GLOOPS 0>
			      <COND (<PRSO? ,LARGE-VIAL>
				     <SETG LARGE-VIAL-GLOOPS 0>
				     <SETG LARGE-VIAL-IMPRECISE <>>
			     ...
			     (T
			      ...
			      <TELL
" You pour as carefully as you can, and it appears to the naked eye that
there are now " N .VIAL-GLOOPS " gloops in the vial. However, since there are
no gradations on the vial, it's impossible to be certain." CR>)>)>)>>
...
<ROOM HEART-OF-MINE
      ...
      (DESC "Heart of Mine")
      (LDESC
"You in a major granola mine. Half-mined granola is everywhere. The remains
...
<ROUTINE GRANOLA-F ()
	 <COND (<VERB? EXAMINE>
		<TELL "It looks typically unappetizing." CR>)
	       (<VERB? EAT TASTE>
		<STEP-IN-IT "tastes">)
	       (<TOUCHING? ,GRANOLA>
		<STEP-IN-IT "feels">)
		...
		<TELL "Oh, yechh!" CR>)
	       (<VERB? RESEARCH>
		<PERFORM ,V?RESEARCH ,WEST-OF-HOUSE>
		<RTRUE>)>>
