...
<ROUTINE GAME-VERB? () ;"should the verb not run the clock?"
	 <COND (<VERB? VERSION HINT $RECORD $UNRECORD $COMMAND $RANDOM
		       SCORE SAVE RESTORE RESTART QUIT SCRIPT UNSCRIPT
		       BRIEF SUPERBRIEF VERBOSE $VERIFY TIME MAP DEFINE>
		<RTRUE>)>>>
...
<ROUTINE CAPITAL-NOUN? (WRD)
	 <COND (<EQUAL? .WRD ,W?FLATHEAD ,W?DIMWIT ,W?URSULA ,W?MEGABOZ ,W?JOHN
			     ...
			     ,W?RALPH ,W?PAUL ,W?FRANK ,W?LLOYD ,W?BABE
			     ,W?SEYMOUR ,W?SHERMAN ,W?IRVING ,W?SAMMY ,W?MYRON
			     ,W?BORIS ,W?MELVIN ,W?LESTER ,W?JULIUS ,W?RICARDO
			     ,W?OMAR ,W?BARNABY ,W?MERETZKY>
		<RTRUE>)
	       (T
		<RFALSE>)>>>
