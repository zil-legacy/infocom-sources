...
<BUZZ  A AN THE IS ARE AM AND OF THEN ALL ;ONE BUT EXCEPT \. \, \" PLEASE
       DON\'T DONT NOT
       THIS THAT PRY HERE SOME FRONT MORE POUNDS G AGAIN OOPS ;SEX>
...
<VERB-SYNONYM CLIMB SCALE CRAWL>
...
<SYNTAX MOVE DOWN OBJECT (ON-GROUND IN-ROOM) = V-LOWER PRE-TOUCH>
...
<SYNTAX STICK OBJECT (HELD CARRIED) BEFORE OBJECT = V-WAVE>
...
<VERB-SYNONYM TURN SET SPIN SWITCH STEER ROTATE FLIP FLICK CHANGE>

<SYNTAX UNCOVER OBJECT = V-UNCOVER>
<VERB-SYNONYM UNCOVER UNBLOCK UNPLUG>
...
<SYNTAX WAVE OBJECT (HAVE) BEFORE OBJECT = V-WAVE-NEAR>
<SYNTAX WAVE OBJECT (HAVE) IN OBJECT = V-WAVE-NEAR>
<SYNTAX WAVE OBJECT (HAVE) BEFORE OBJECT = V-WAVE> 

<SYNTAX WEAR OBJECT (FIND WEARBIT) (HAVE) = V-WEAR>
<VERB-SYNONYM WEAR DON>

<SYNTAX WHAT OBJECT = V-WHAT>
<VERB-SYNONYM WHAT WHATS WHAT\' WHO WHICH WHOS>
