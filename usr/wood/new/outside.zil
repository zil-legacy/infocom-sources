...
<ROOM WEST-CASTLE
      ...
      (DESC "Outside door")
      (EAST TO INSIDE-GATE
            IF IRON-GATE IS OPEN ELSE "The emergency door is locked.")
      (IN TO INSIDE-GATE
          IF IRON-GATE IS OPEN ELSE "The emergency door is locked.")
...
<ROUTINE WEST-CASTLE-F (RARG)
	 <COND (<EQUAL? .RARG ,M-LOOK>
		<TELL
"You are inside the theater at the emergency door which is ">
		<COND (<FSET? ,IRON-GATE ,OPENBIT>
		       <TELL "wide open">)
		      (T <TELL "closed and chained">)>
		<TELL ". An asile which runs back to the theater lobby ends here." CR>)>>

<ROOM WESTERN-ROAD
      (IN ROOMS)
      (DESC "Theater Lobby")
      (LDESC
"You are in the lobby of the theater, the smell of melted butter heavy in the air.  As theater-goers file through the swinging doors to their seats at the east, you notice the flickering images of tonight's feature, ZORK: THE MOVIE.  Through the glass front of the building to the west you observe a downcast tourist, who is eyeing the sidewalk, with a nametag, HI, MY NAME IS PHONG.")
      (EAST TO WEST-CASTLE)
      (WEST TO EAST-FORK)
      (NORTH
"You would be burned by the popcorn machine.  And the cashier is wearing braces.")
      (SOUTH
"A goony-looking usher, wearing a ZORK button and smiling broadly, blocks your passage.")
      (FLAGS RLANDBIT ONBIT LIGHTBIT)
      (GLOBAL HILLS MOUNTAIN DISTANT-CASTLE)>

<ROOM EAST-FORK
      (IN ROOMS)
      (DESC "Outside Theater")
      (LDESC
"You are standing outside the famous Gramann's Chinese Theater, among the milling tourists who are gawking at the sidewalk. Glancing down, you notice your right shoe is filling the footstep of Montgomery Clift. To the east a negligent ticket-taker is away from his post at the entrance, waving his arms while decribing to cuostomers how the moveie ends.")
      (NW TO TRAIL-HEAD)
      (SW TO VILLAGE-EAST)
...
<ROOM SHACK-ROOM
      (IN ROOMS)
      (DESC "Entrance to Alley")
      (LDESC "You are south of a seedy-looking alley. There's no telling
what kind of primative life you might find to the north. The street
extends from northeast to southwest here, circling the Hollywood Sign,
...
<ROOM SHACK
      (IN ROOMS)
      (DESC "In Alley")
      (LDESC "The alley is lined with over-flowing garbage cans, long
forgotten by the city sanitation department. An old wino, ill-shaven and
dishevelled, is crouched near a hot air duct, apparently sleeping. There is slight buldge in the breast pocket of his threadbare coat. The alley exit is to the south.")
      (FLAGS RLANDBIT ONBIT LIGHTBIT)
      (GLOBAL SHACK-OBJ WINDOW) (SOUTH TO SHACK-ROOM) (OUT TO
      SHACK-ROOM) (TEXT
...
<OBJECT BATTERED-LANTERN
	(IN SHACK)
	(DESC "battered ghetto blaster")
	(FDESC
"A battered ghetto blaster, partially visible, is sticking out of a nearby trash can.")
	(SYNONYM GHETTO BLASTER)
	(ADJECTIVE BATTERED)
	(FLAGS TAKEBIT)
...
<ROUTINE BATTERED-LANTERN-F ()
	 <COND (<VERB? ERASE-LINE>
		<TELL "Magic Johnson you're not." CR>)
	       (<VERB? LAMP-ON>
		<TELL
"The blaster comes to life and blares about 15 seconds of James Brown's funkiest music before suddenly going dead. The batteries are apparently very weak." CR>)
               (<VERB? EXAMINE>
                <TELL
...
<ROUTINE SHACK-OVEN-F ()
	 <COND (<VERB? LAMP-ON LAMP-OFF>
		<TELL "It's not working." CR>)
	       (<VERB? EXAMINE>
		<TELL
"The pocket is buldging." CR>)>>

<OBJECT BREAD
	(IN SHACK-OVEN)
	(DESC "pack of cigarettes")
	(SYNONYM CAMELS CIGARETTES PACK)
	(SIZE 8)
	(FLAGS TAKEBIT)
	(ACTION BREAD-F)>
...
"There's not many left, though."
"There's only a few left, though."
"There's still quite a few left, too."
"There's nearly half of it left, too."
"There's still about half of it left, too."
"There's a lot of cigarettes left, too."
"There's a whole lot of them left, too."
"There's a full pack, too.">>
