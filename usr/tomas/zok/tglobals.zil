...
<OBJECT GLOBAL-OBJECTS
	...
	(FLAGS INVISIBLE TOUCHBIT SURFACEBIT TRYTAKEBIT OPENBIT SEARCHBIT
	       ...
	       ACTORBIT FAKEBIT FEMALEBIT INBIT)>
...
<ROUTINE INTNUM-F ("AUX" WHICH)
	 <COND (<EQUAL? ,HERE ,HAZY-ROOM>
		<COND (<EQUAL? ,P-NUMBER 1>
		       <SET WHICH ,DOOR-ONE>)
		      (<EQUAL? ,P-NUMBER 2>
		       <SET WHICH ,DOOR-TWO>)
		      (<EQUAL? ,P-NUMBER 3>
		       <SET WHICH ,DOOR-THREE>)
		      (<EQUAL? ,P-NUMBER 4>
		       <SET WHICH ,DOOR-FOUR>)
		      (T
		       <COND (<ADJ-USED ,A?DOOR>
			      <TELL "There are four doors." CR>
		              <RTRUE>)
			     (T
			      <RFALSE>)>)>
		<COND (<PRSO? ,INTNUM>
...
<ROUTINE CANT-SEE-ANY (OBJ)
	 <TELL ,YOU-CANT-SEE-ANY D .OBJ " here." CR>>
