...
<GLOBAL BOK <>>  ;"Just for fun."

<ROUTINE GO () ;"NOTE: this routine CANNOT have any local variables" 
	 <COND (<AND <EQUAL? <GETB 0 56> 84>
		     <EQUAL? <GETB 0 57> 79>>
		<SETG BOK T>)>
	 <COND (,BOK
		<TELL CR "Howdy, Tom." CR CR>
		;<SETG DEBUG T>)>
	 <SETG WINNER ,PROTAGONIST>
	 <SETG HERE ,IN-BED>
	 ;<CLEAR-SCREEN> ;"ONLY NECESSARY IN ZIL."
	 ;<SET-VTR 4>
	 ;<USL>
	 <TELL
"It's time for school, but today you're taking a well-deserved break. Equipped
with only imaginary ailments, you have succeeded in convincing those in power
that you are sick enough to spend a day in bed, watching TV. Unfortunately,
Elsa, the new Swedish maid, (who you suspect would be more comfortable
dressing as a Viking, than as a house-keeper) has very strict ideas about how
to care for oneself when one is sick. You are saving the tray of applesauce,
probably doctored with some form of medicine, as evidence, to be presented
to your Mom and Dad when they get home tonight." CR CR>
	 <V-VERSION>
	 <CRLF>
	 ;<SETG HERE ,IN-BED>
	 <V-LOOK>
...
<ROUTINE MAIN-LOOP-1 ("AUX" ICNT OCNT NUM CNT OBJ TBL V PTBL OBJ1 TMP)
  ...
  <COND (,P-WON
	 ...
	 <SETG PRSA <>>
	 ;<SETG SPECIAL-CASE-DONT <>>  ;"NOW HANDLED IN PARSER"
	;<COND (,DONT-FLAG
		   <SETG L-DONT-FLAG T>)
		  (T
		   <SETG L-DONT-FLAG <>>)>
