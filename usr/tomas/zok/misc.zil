...
politico. So.." ,HIT-RETURN "begin!">
	 ;<READ ,P-INBUF ,P-LEXV>
	 ;<CLEAR-SCREEN>
	 ;<OPENING-TEXT>    ;"REMOVE SEMI TO PRINT OPENING MESSAGES."
...
<ROUTINE OPENING-TEXT ()
	 <TELL
"   You dream that you're at the controls of your space vessel, the S.K.S.
StingRay, but instead of running a routine maintenance trip, you're
responding to a distress signal from a nearby ship. 
"CR
"A soft, female voice comes through your radio:|
   \"Help me! My ship, the Camelia, is under attack from a Wyrrn dreadnought!
We can't hold out! They're taking us in...\" The tranmission is cut off." CR CR
"   You bark some orders to Benny, the onboard computer, and speed into the 
vicinity of the huge Wyrrn Alliance dreadnought, closing in on a tiny landing
bay, hiding your presence from short-range scanners with cloaking devices you
didn't even know you had. But as you approach the bay, you drift back into the
less-active states of slumber, and all goes blank." CR CR
"   Some time later, you are awakened by Benny's soothing voice:|
   \"Captain, we're docking! I've performed all preliminary checks and
functions. Get set to land.\"" CR CR
"   You open open your eyes, and stare through the plexi-plate window at the
landing bay ahead of you, almost choking with surprise, as you see the
unmistakeable seal of the Wyrrn Alliance marked upon the runway, signifying 
that your ship is on board a W.A.F. dreadnought!|
| 
A dull bump reminds you that your ship has landed." CR>>
