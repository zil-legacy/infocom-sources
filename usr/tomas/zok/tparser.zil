...
"[There were too many nouns in that sentence.]" CR>
			     ...
			     (<AND <EQUAL? .WRD ,W?NOT>
			      ...
			      <COND (,DEBUG
				     <TELL "Dont = True."CR>)>)
		;"PREVIOUS HACK TO ALLOW TELL <FOO> NOT TO <BAR> -- TJB"
			     (<WT? .WRD ,PS?BUZZ-WORD>)
	...
	<COND (.DIR
	       ...
	       <SETG P-OFLAG <>>
	       <SETG P-WALK-DIR .DIR>
	       <COND (,SPECIAL-CASE-DONT
		      <SET DONT T>
		      <SETG SPECIAL-CASE-DONT <>>
		      <COND (,DEBUG <TELL "SCD -- DON'T NOW TRUE.">)>)>
	       <SETG DONT-FLAG .DONT>
	       <SETG AGAIN-DIR .DIR>
	       <RETURN T>)>
	<SETG P-WALK-DIR <>>
