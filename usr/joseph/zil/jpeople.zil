...
<OBJECT SUSI
	(LOC RAMP)
	(DESC "Susi")
	(TEXT "Susi Kmetzo is far more attractive than most pre-school teachers.")
	(ADJECTIVE SUSI DARK-HAIR DARK HAIRED MS)
	(SYNONYM SUSI KMETZO WOMAN SUSAN)
...
<ROUTINE -D ("OPTIONAL" (ARG <>))
	<DESCRIBE-PERSON ,>
	<RTRUE>>

<ROUTINE SUSI-D ("OPTIONAL" X)
	 <COND (<EQUAL? <GETP ,,P?LDESC> 14 ;"asleep">
		<TELL "is in the corner, snoring loudly." CR>)
	       (T
